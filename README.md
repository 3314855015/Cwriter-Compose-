...
- 给不会用的(可能看小说评论区少的)提一嘴：写到自己预备有伏笔的段落时，不要吝啬你心中的想法，大大方方将“剧透”打在评论区【创造伏笔】内，给“未来的自己”【回收伏笔】时，分享分享，后边回收时，直接长按注释掉就可以了。（目前UI有点抽象，而且，有些错别字，理解理解）
...
- 这个也是没什么使用说明的，使用方法，时间紧迫的，有明显重复规律，就按照时间线构造大纲；不想按时间写，按事件记事的，就像我第一卷这种，大家都懂，我只给放两张示意图：
